...
async function addToServer(audios) {
    for (i = 0; i < audios.length; i++) {
        ...
        const audio = { id: uuidv4(), title: audios[i].title, url: `https://r4realiable.github.io/audiostories/Malayalam/${audios[i].name}.mp3`, language: 'english', artist: 'kambi maman', description: audios[i].title }
